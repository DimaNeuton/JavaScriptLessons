...
const ones = userNumber % 10;
const tens = ((userNumber - ones) / 10) %10;
const hundreds = ((userNumber - tens * 10 - ones) / 100) % 10;
alert(`В числе ${userNumber} количество сотен: ${hundreds}, десятков: ${tens}, единиц: ${ones}`);
